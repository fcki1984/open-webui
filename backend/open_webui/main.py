...
app.state.config.ENABLE_SUMMARIZE_GENERATION = ENABLE_SUMMARIZE_GENERATION
...
app.state.config.SUMMARIZE_GENERATION_PROMPT_TEMPLATE = (
    SUMMARIZE_GENERATION_PROMPT_TEMPLATE
)
    ...
    try:
        ...
        async with aiohttp.ClientSession(timeout=timeout, trust_env=True) as session:
            async with session.get(
                "https://api.github.com/repos/ztx888/open-webui/releases/latest",
